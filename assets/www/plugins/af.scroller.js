...
(function ($) {
    "use strict";
    var HIDE_REFRESH_TIME = 825; // hide animation of pull2ref duration in ms
    var cache = [];
    ...
    var scroller = (function () {
        ...
        jsScroller.prototype.onTouchEnd = function (event) {
            ...
            this.scrollerMoveCSS(scrollInfo, scrollInfo.duration == 0 ? 0 : HIDE_REFRESH_TIME, "cubic-bezier(0.33,0.66,0.66,1)");
            this.setVScrollBar(scrollInfo, scrollInfo.duration == 0 ? 0 : HIDE_REFRESH_TIME, "cubic-bezier(0.33,0.66,0.66,1)");
            this.setHScrollBar(scrollInfo, scrollInfo.duration == 0 ? 0 : HIDE_REFRESH_TIME, "cubic-bezier(0.33,0.66,0.66,1)");
